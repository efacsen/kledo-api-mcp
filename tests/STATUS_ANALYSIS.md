...
📊 STATUS_ID = 1
   ...
   💡 Analysis:
      → Likely UNPAID/PENDING (due = total amount)
...
📊 STATUS_ID = 3
   ...
   💡 Analysis:
      → Likely PAID (due=0, most have paid_date)
      Average due: Rp 0
...
📊 TYPE_ID = 2
   ...
   Sample 1:
     - Name: Yadi
     - Company: PT. SAMPLE DISTRIBUTION CO
     - Type Name: None
     - Receivable: Rp 0.00
     - Payable: Rp 0.00
...
Invoice: INV/26/JAN/01152
  Subtotal (before tax): Rp 7,000,000
  Tax: Rp 831,600
  Amount After Tax: Rp 8,000,000
  Calculated (subtotal + tax): Rp 8,000,000
  ✓ Matches: True
