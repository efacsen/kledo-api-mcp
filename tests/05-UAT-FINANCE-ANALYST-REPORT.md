...
```json
{
  ...
  "sales_person": {"id": 352181, "name": "Sales Rep A"},
...
|-----------|-----------|-------------|----------|-----------|
| Meka GN | Rp 7,000,000 | Rp 8,000,000 | 1 | 1 |
| Sales Rep A | Rp 6,930,000 | Rp 7,207,200 | 2 | 2 |
| **TOTAL** | **Rp 14,490,000** | **Rp 15,598,800** | **3** | **3** |

**Average Deal Size**:
- Meka GN: Rp 7,000,000 per invoice
- Sales Rep A: Rp 3,465,000 per invoice

**Calculation Verification**:
```
Meka GN:
  1 invoice × Rp 7,000,000 = Rp 7,000,000 ✓
