...
|-----------|-----------|-------------|----------|-----------|----------|
| Meka GN | Rp 7,000,000 | Rp 8,000,000 | 1 | 1 | Rp 7,000,000 |
| Sales Rep A | Rp 6,930,000 | Rp 7,207,200 | 2 | 2 | Rp 3,465,000 |
```

**Verification Checks**:
- [ ] Only paid invoices (2 total, unpaid excluded)
- [ ] Meka GN: 1 invoice × Rp 7,000,000 ✓
- [ ] Vendor D: 2 invoices × Rp 3,465,000 average ✓
...
|------|----------|----------|-----------|-------------|-------------|
| 1 | Customer C (PT. SAMPLE TRADING CO) | 1 | Rp 7,000,000 | Rp 8,000,000 | Rp 7,000,000 |
