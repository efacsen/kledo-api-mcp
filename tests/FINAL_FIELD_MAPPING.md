...
```
Subtotal:         Rp 7,000,000  ← Use for commission calculation
Tax (PPN 11%):    Rp   831,600
Amount After Tax: Rp 8,000,000  ← Use for revenue reporting
```
...
| `sales_person.name` | string | Sales rep name | Sales person name | "Sales Rep A" |
...
| `contact.name` | string | Vendor name | Vendor/supplier name | "Contact Person A" |
