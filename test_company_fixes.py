...
async def test_fixes():
    ...
    auth = KledoAuthenticator(
        base_url=os.getenv("KLEDO_BASE_URL", "https://demo.api.kledo.com/api/v1"),
    ...
    fuzzy_tests = [
        ("CoatingCo", "PT Nippon Paint Indonesia", "Darma"),
        ("Nipon", "PT Nippon Paint Indonesia", "Darma"),
        ("Nippon", "PT Nippon Paint Indonesia", "Darma"),
        ("Kurnia", "PT. KURNIA PROPERTINDO SEJAHTERA", "Customer G"),
        ("Alta", "PT. ALTA AIRINDO GEMILANG", "Customer E"),
    ]
